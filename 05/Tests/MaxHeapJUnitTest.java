...
public class MaxHeapJUnitTest {
    ...
    public void resizeAndRemove() {
        ...
        Integer[] before = new Integer[MaxHeap.INITIAL_CAPACITY];
        before[1] = 59;
        before[2] = 47;
        before[3] = 31;
        before[4] = 22;
        ...
        before[11] = 29;
        before[12] = 4;
        assertArrayEquals(before, maxHeap.getBackingArray());
        //make the expected backing array and check if the entries are correct before the resize occurs
        maxHeap.add(73); //resize will occur here
        maxHeap.add(100);
        assertEquals(14, maxHeap.size());
        Integer[] expected = new Integer[MaxHeap.INITIAL_CAPACITY * 2];
    ...
    //use build heap and get max test
    @Test
