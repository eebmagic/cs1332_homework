...
public class ReWrite<K, V> {
    ...
    public V put(K key, V value) {
        ...
        int targetIndex = key.hashCode() % table.length;
        ...
        while (curr != null && newNode == null && curr.getNext() != null) {
            curr = curr.getNext();
        }
    ...
    public V remove(K key) {
        ...
        int targetIndex = key.hashCode() % table.length;
        if (table[targetIndex] == null) {
            /// fix these traversals to not need this if statement
            ...
            if (curr.getKey().equals(key) && curr.getNext() == null) {
                ...
                while (!(curr.getNext().getKey().equals(key))) {
                    curr = curr.getNext();
                }
    ...
    public void resizeBackingTable(int length) {
        ...
        ExternalChainingMapEntry<K, V>[] newArr = new ExternalChainingMapEntry[length];
        for (int i = 0; i < Math.min(length, table.length); i++) {
            newArr[i] = table[i];
        }
        table = newArr;
    }
