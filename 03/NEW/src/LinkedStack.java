...
public class LinkedStack<T> {
    ...
    public T pop() {
        if (size == 0) {
            throw new NoSuchElementException("cannot pop item off of an empty structure");
        }
    ...
    public T peek() {
        if (size == 0) {
            throw new NoSuchElementException("cannot peek at item because structure is empty");
        }
        return head.getData();
    }
